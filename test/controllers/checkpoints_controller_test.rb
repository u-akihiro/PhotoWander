...
class CheckpointsControllerTest < ActionController::TestCase
  ...
  test "should create checkpoint" do
    assert_difference('Checkpoint.count') do
      post :create, checkpoint: { lat: @checkpoint.lat, lng: @checkpoint.lng, name: @checkpoint.name, radius: @checkpoint.radius, ucode: @checkpoint.ucode }
    end
  ...
  test "should update checkpoint" do
    patch :update, id: @checkpoint, checkpoint: { lat: @checkpoint.lat, lng: @checkpoint.lng, name: @checkpoint.name, radius: @checkpoint.radius, ucode: @checkpoint.ucode }
    assert_redirected_to checkpoint_path(assigns(:checkpoint))
  end
